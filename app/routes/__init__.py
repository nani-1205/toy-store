...
def create_app(config_class=Config):
    ...
    # Add the 'do' extension before loading config or initializing anything else
    ...
    # --- DB Config Section ---
    # (DB Config code remains the same)
    ...
    # (DB Init code remains the same as the last successful version)
